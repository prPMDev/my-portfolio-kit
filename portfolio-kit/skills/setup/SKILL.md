...
> "Welcome — I'll get you from raw material to a live portfolio, no coding. The path: **setup** (a few basics, now) → **find-my-voice** (so it sounds like you) → **story-adapter** (turn work into safe case studies) → **assemble** (build the page) → **refresh** (keep it current). Let's start."
...
> "Setup done. Next: run **find-my-voice** so everything sounds like you. Then **story-adapter** turns your work into safe case studies, **assemble** builds the page, and **refresh** keeps it current."
